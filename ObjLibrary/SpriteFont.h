...
//  Returns: N/A
#ifdef OBJ_LIBRARY_SHADER_DISPLAY
//  Side Effect: The 2d view is marked as not set up.
#else
...
//    <1> red
//    <2> green
//    <3> blue: The colour to draw the string with
//    <4> alpha: The transparency to draw the string with
...
//               needed for drawing text using this SpriteFont.
//
	void setUpForDrawing (unsigned char red,
	                      unsigned char green,
	                      unsigned char blue,
	                      unsigned char alpha,
	                      unsigned int format) const;
