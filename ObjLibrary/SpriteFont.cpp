...
//      -> Draws the health image based on texture coordinates
//
...
namespace
{
	...
	constexpr unsigned int POSITION_COMPONENT_COUNT = 2;
	constexpr unsigned int POSITION_ELEMENT_COUNT   = BLOCK_SIZE_MAX * POSITION_COMPONENT_COUNT;

	constexpr unsigned int CHARACTER_COMPONENT_COUNT = 1;
	constexpr unsigned int CHARACTER_ELEMENT_COUNT   = BLOCK_SIZE_MAX * CHARACTER_COMPONENT_COUNT;
                         ...
                         double y) const
{
	...
	draw(string(a_str), x, y, 0xFF, 0xFF, 0xFF, PLAIN, 0xFF);
}
                         ...
                         double y) const
{
	...
	draw(str, x, y, 0xFF, 0xFF, 0xFF, PLAIN, 0xFF);
}
                         ...
                         unsigned int format) const
{
	...
	draw(string(a_str), x, y, 0xFF, 0xFF, 0xFF, format, 0xFF);
}
                         ...
                         unsigned int format) const
{
	...
	draw(str, x, y, 0xFF, 0xFF, 0xFF, format, 0xFF);
}
                         ...
                         unsigned char blue) const
{
	...
	draw(string(a_str), x, y, red, green, blue, PLAIN, 0xFF);
}
                         ...
                         unsigned char blue) const
{
	...
	draw(str, x, y, red, green, blue, PLAIN, 0xFF);
}
                         ...
                         unsigned int format) const
{
	...
	draw(string(a_str), x, y, red, green, blue, format, 0xFF);
}
                         ...
                         unsigned int format) const
{
	...
	draw(str, x, y, red, green, blue, format, 0xFF);
}
                         ...
                         unsigned char alpha) const
{
	...
	draw(string(a_str), x, y, red, green, blue, format, alpha);
}
                         ...
                         unsigned char alpha) const
{
	...
	setUpForDrawing(red, green, blue, alpha, format);
	drawLineOfText(str, x, y, format);
	unsetUpForDrawing();
}
                         ...
                         unsigned char alpha) const
{
	...
	{
		y = drawLineOfText(lines[i], x, y, format);
...
void SpriteFont :: setUpForDrawing (unsigned char red,
                                    unsigned char green,
                                    unsigned char blue,
                                    unsigned char alpha,
                                    unsigned int format) const
{
	...
	ObjShader::activateSpriteFont(g_2d_view_size, (float)(m_image_size), colour, format);
                                     ...
                                     unsigned int format) const
{
	...
	drawLineThrough(x, end_x, y +  m_character_height + 1,      format &     UNDERLINE_MASK);
	drawLineThrough(x, end_x, y + (m_character_height * 2) / 3, format & STRIKETHROUGH_MASK);
